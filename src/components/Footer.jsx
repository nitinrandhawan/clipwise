...
function Footer() {
  return (
    <footer>
    <div className="bg-[#0a294d]  text-gray-400 px-20 py-10">
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
            <a href="/" className="block w-56 mb-10">
              <h1 className='text-5xl text-center text-white '>Clipwise</h1>
            </a>
            <p className="text-justify">
            Clipwise.ai is an AI video generator platform designed to enable users to create captivating animated videos for platforms like YouTube Shorts/Reels using simple text prompts.  </p>
          </div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              <li><a href="#" className="hover:text-blue-400">The platform is user-friendly, requiring no prior animation </a></li>
              <li><a href="#" className="hover:text-blue-400">video editor</a></li>
              <li><a href="#" className="hover:text-blue-400">AI video generator platform.</a></li>
              <li><a href="#" className="hover:text-blue-400">Build captivating websites.</a></li>
    ...
    <div className="bg-blue-700 py-2 text-gray-100">
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-center items-center">
          <span className=" w-full text-center sm:w-auto sm:text-left">
            Copyright © 2024
           clipwise. All Rights Reserved by Nitin Gupta.
          </span>
